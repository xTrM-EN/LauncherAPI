...
public class TextField extends JTextField {
	...
	public TextField(String baseText, int x, int y, int width, int height) {
		this(baseText, new int[] {x, y, width, height}, Color.WHITE);
	}
	
	public TextField(String baseText, int x, int y, int width, int height, Color textColor) {
		this(baseText, new int[] {x, y, width, height}, textColor);
	}
	
	public TextField(String baseText, int[] bounds) {
